...
import com.gslab.com.flink.jdbc.connector.source.JDBCSource;
...
public class App {
	public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<ObjectNode> stream = (DataStreamSource<ObjectNode>)env.addSource(new JDBCSource(jsonDeserialiationSchema, properties));
